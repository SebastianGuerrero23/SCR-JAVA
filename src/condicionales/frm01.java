...
public class frm01 extends JFrame {
    ...
    public frm01() {
        ...
        btnCalcular.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                btnCalcular_actionPerformed();  // Llama a la función para realizar los cálculos
            }
        });
    }
    ...
    protected void btnCalcular_actionPerformed() {
        try {
            int unidades = Integer.parseInt(txtUnidades.getText());  // Lee el número de unidades

            // Lógica para determinar el precio por unidad
            int precio = (unidades <= 25) ? 27 : 23;

            // Cálculo de la compra total
            double compra = precio * unidades;
            // Cálculo del descuento basado en la cantidad de unidades
            double descuento = (unidades > 50) ? 0.15 * compra : 0.05 * compra;

            // Cálculo del total a pagar
            double total = compra - descuento;

            // Actualización de los campos de texto con los resultados
